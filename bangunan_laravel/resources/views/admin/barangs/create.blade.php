    ...
    <div class="card-body">
        <form action="{{ route("admin.barangs.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                ...
                <input readonly type="text" id="id" name="id" class="form-control" value="{{ $barangs }}" required>
                @if($errors->has('id'))
                    <p class="help-block">
                        {{ $errors->first('id') }}
                    </p>
            ...
            <div class="form-group {{ $errors->has('stok') ? 'has-error' : '' }}">
                ...
                <input type="text" id="stok" name="stok" class="form-control" value="{{ old('stok', isset($barang) ? $barang->stok : '') }}">
                @if($errors->has('stok'))
                    <p class="help-block">
                        {{ $errors->first('stok') }}
                    </p>
